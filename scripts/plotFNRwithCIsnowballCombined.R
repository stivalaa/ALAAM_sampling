#!/usr/bin/Rscript
#
# File:    plotFNRwithCIsnowballCombined.R
# Author:  Alex Stivala
# Created: September 2015
#
# $Id: plotFNRwithCIsnowballCombined.R 648 2016-09-27 07:40:15Z stivalaa $
#
...
#
# Usage: Rscript plotFNRwithCIsnowballCombined.R  baseline_Stats_Table.txt outfilename.eps
#
...
p <- ggplot(D, aes(x = numSeeds, y = FNRpercent,
...
if (landscape) {
    p <- p + scale_x_discrete(breaks=seq(0, maxNumSeeds, 4))
}    else {
