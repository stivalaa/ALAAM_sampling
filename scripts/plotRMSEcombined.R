#!/usr/bin/Rscript
#
# File:    plotRMSEcombined.R
# Author:  Alex Stivala
# Created: September 2015
#
# $Id: plotRMSEcombined.R 648 2016-09-27 07:40:15Z stivalaa $
#
...
# RMSE
#
# Usage: Rscript plotRMSEcombined.R baseline_Stats_table.txt  outfilename.eps
#
...
D <- D[which(D$numSeeds > 1), ] # error bar on RMSE too large for 1 seed
