#!/usr/bin/Rscript
#
# File:    snowballSampleMultiAttrFull.R
# Author:  Alex Stivala
...
#
# Usage: Rscript snowballSampleMultiAttrFull.R num_waves num_seeds networkFilename binAttrFileName catAttrFileName outcomeFilePattern
#
...
if (length(args) != 6) {
 cat('Usage: Rscript snowballSampleMultiAttrFull.R num_waves num_seeds networkFilename binAttrFileName catAttrFileName outcomeFilePattern\n')
 quit(save="no")
}
